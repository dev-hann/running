...
abstract class $RecordItemCopyWith<$Res> {
  ...
  @useResult
  $Res call({DateTime dateTime, LatLng latlng});
}
...
class _$RecordItemImpl implements _RecordItem {
  _$RecordItemImpl({required this.dateTime, required this.latlng});
  ...
  @override
  String toString() {
    return 'RecordItem(dateTime: $dateTime, latlng: $latlng)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, dateTime, latlng);
...
abstract class _RecordItem implements RecordItem {
  factory _RecordItem(
      ...
      required final LatLng latlng}) = _$RecordItemImpl;
